...
@WebServlet("/Sepeturunsiparisnakit")
public class Sepeturunsiparisnakit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public Sepeturunsiparisnakit() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String odeme = request.getParameter("nakit");
